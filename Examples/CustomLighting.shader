...
////// Lighting:
                ...
                float node_58 = pow(max(0,dot(normalDirection,halfDirection)),exp2(((_Gloss*10.0)+1.0))); // Specular Light
                float3 finalColor = (attenuation*_LightColor0.rgb*(((_Diffuse_var.rgb*_Color.rgb*node_40)+UNITY_LIGHTMODEL_AMBIENT.rgb)+(_Specular_var.r*node_58)));
