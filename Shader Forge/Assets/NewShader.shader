...
/*SF_DATA;ver:0.15;sub:START;pass:START;ps:lgpr:1,nrmq:1,limd:4,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,uamb:True,ufog:True,aust:True,igpj:False,qofs:0,lico:1,qpre:1,flbk:,rntp:1,lmpd:False,enco:False,frtr:True,vitr:True,dbil:True,rmgx:True;n:type:ShaderForge.SFN_Final,id:1,x:32540,y:32732|diff-4-OUT,spec-35-OUT,gloss-41-OUT,normal-51-RGB,emission-58-OUT;n:type:ShaderForge.SFN_Slider,id:2,x:33229,y:32911,ptlb:Gloss,min:0,cur:0.4962406,max:1;n:type:ShaderForge.SFN_Color,id:3,x:33342,y:32601,ptlb:Color,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:4,x:33114,y:32537|A-5-RGB,B-3-RGB;n:type:ShaderForge.SFN_Tex2d,id:5,x:33342,y:32431,ptlb:MainTex,tex:b66bceaf0cc0ace4e9bdc92f14bba709|UVIN-47-OUT;n:type:ShaderForge.SFN_TexCoord,id:27,x:34129,y:32210,uv:0;n:type:ShaderForge.SFN_Vector4Property,id:28,x:34348,y:32406,ptlb:Tiling,v1:1,v2:1,v3:0,v4:0;n:type:ShaderForge.SFN_Cubemap,id:29,x:33752,y:33147,ptlb:Shine,cube:2f821dbbb5e173e468876ef2e4eaa490,pvfc:0;n:type:ShaderForge.SFN_ValueProperty,id:30,x:33539,y:33351,ptlb:Emission,v1:8;n:type:ShaderForge.SFN_Multiply,id:35,x:33041,y:32679|A-5-R,B-79-OUT;n:type:ShaderForge.SFN_Multiply,id:41,x:33041,y:32844|A-5-R,B-2-OUT;n:type:ShaderForge.SFN_Add,id:47,x:33741,y:32424|A-49-OUT,B-48-OUT;n:type:ShaderForge.SFN_Append,id:48,x:34129,y:32503|A-28-Z,B-28-W;n:type:ShaderForge.SFN_Multiply,id:49,x:33933,y:32284|A-27-UVOUT,B-50-OUT;n:type:ShaderForge.SFN_Append,id:50,x:34129,y:32361|A-28-X,B-28-Y;n:type:ShaderForge.SFN_Tex2d,id:51,x:33385,y:33007,ptlb:Normals,tex:bbab0a6f7bae9cf42bf057d8ee2755f6|UVIN-47-OUT;n:type:ShaderForge.SFN_Multiply,id:52,x:33041,y:33012|A-5-R,B-56-OUT;n:type:ShaderForge.SFN_Multiply,id:55,x:33539,y:33201|A-29-RGB,B-29-A;n:type:ShaderForge.SFN_Multiply,id:56,x:33359,y:33231|A-55-OUT,B-30-OUT;n:type:ShaderForge.SFN_Multiply,id:58,x:32883,y:32913|A-41-OUT,B-52-OUT;n:type:ShaderForge.SFN_Vector1,id:79,x:33386,y:32779,v1:0.7;proporder:3-5-2-30-28-51-29;pass:END;sub:END;*/
...
////// Specular:
                ...
                float3 specular = attenColor * float3(node_35,node_35,node_35)*NdotL * pow(max(0,dot(halfDirection,normalDirection)),gloss)*fresnelTerm*visTerm*normTerm;
