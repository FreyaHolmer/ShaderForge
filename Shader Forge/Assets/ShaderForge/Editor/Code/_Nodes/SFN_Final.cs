...
namespace ShaderForge {
	...
	public class SFN_Final : SF_Node {
		...
		public SFN_Final Initialize( SF_Editor editor ) {
			...
			base.rect = new Rect( pos.x - NODE_WIDTH / 2, pos.y - NODE_HEIGHT / 2, NODE_WIDTH * 1.5f, 338 );
			...
			this.connectors = new SF_NodeConnection[]{
				...
				//anisotropicDirection 	= SF_NodeConnection.Create(this,     "Anisotropic Direction",	ConType.cInput, ValueType.VTv3			,true					).SetStrID("aniso").Skip(PassType.ShadColl, PassType.ShadCast),
