...
////// Specular:
                ...
                float node_11 = 0.4;
                float4 _Specular_var = tex2D(_Specular,TRANSFORM_TEX(node_1175.rg, _Specular));
                float3 specularColor = float3(_Specular_var.r,_Specular_var.r,_Specular_var.r);
                float3 specularAmb = (lerp((0.3*node_215),node_215,node_223)*((i.normalDir.g*node_11)+(1.0 - node_11))) * specularColor;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float4 _Specular_var = tex2D(_Specular,TRANSFORM_TEX(node_1176.rg, _Specular));
                float3 specularColor = float3(_Specular_var.r,_Specular_var.r,_Specular_var.r);
