        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    float4 node_2747 = _Time + _TimeEditor;
                    float2 node_6 = (v.uv0.rg*2.0);
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX((node_6+node_2747.g*float2(1,0)), _DisplacementR),0.0,node_15));
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float3 node_162 = lerp(float3(0.4117647,0.3826572,0.3602941),(tex2D(_Diffuse,TRANSFORM_TEX(i.uv0.rg, _Diffuse)).rgb*tex2D(_AORGBHeightA,TRANSFORM_TEX(node_6, _AORGBHeightA)).rgb),node_156);
                ...
                float3 finalColor = diffuse * node_162 + specular;
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float2 node_6 = (v.uv0.rg*2.0);
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX((node_6+node_2749.g*float2(1,0)), _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.rgb,node_12.a))*((-1.0)*_Depth)));
                }
                float Tessellation(TessVertex v){
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float2 node_6 = (v.uv0.rg*2.0);
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX((node_6+node_2751.g*float2(1,0)), _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.rgb,node_12.a))*((-1.0)*_Depth)));
                }
                float Tessellation(TessVertex v){
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                void displacement (inout VertexInput v){
                    ...
                    float2 node_6 = (v.uv0.rg*2.0);
                    float node_15 = 1.0;
                    float4 node_152 = tex2Dlod(_DisplacementR,float4(TRANSFORM_TEX((node_6+node_2753.g*float2(1,0)), _DisplacementR),0.0,node_15));
                    float4 node_12 = tex2Dlod(_AORGBHeightA,float4(TRANSFORM_TEX(node_6, _AORGBHeightA),0.0,node_15));
                    v.vertex.xyz +=  (v.normal*((1.0 - max(node_152.rgb,node_12.a))*((-1.0)*_Depth)));
                }
                float Tessellation(TessVertex v){
