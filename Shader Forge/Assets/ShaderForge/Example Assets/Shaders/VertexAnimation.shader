    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((node_8782.rg+node_8783.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
...
////// Specular:
                ...
                float node_8608 = 0.1;
                float3 finalColor = diffuse * lerp(tex2D(_Diffuse,TRANSFORM_TEX(node_8782.rg, _Diffuse)).rgb,float3(node_8608,node_8608,node_8608),node_133) + specular + emissive;
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((node_8784.rg+node_8785.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.posWorld = mul(_Object2World, v.vertex);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
                TRANSFER_VERTEX_TO_FRAGMENT(o)
...
////// Specular:
                ...
                float node_8608 = 0.1;
                float3 finalColor = diffuse * lerp(tex2D(_Diffuse,TRANSFORM_TEX(node_8784.rg, _Diffuse)).rgb,float3(node_8608,node_8608,node_8608),node_133) + specular;
/// Final Color:
                return fixed4(finalColor,1);
            }
            ENDCG
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8786 = o.uv0;
                float node_133 = pow((abs((frac((node_8786.rg+node_8787.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_8788 = o.uv0;
                float node_133 = pow((abs((frac((node_8788.rg+node_8789.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
