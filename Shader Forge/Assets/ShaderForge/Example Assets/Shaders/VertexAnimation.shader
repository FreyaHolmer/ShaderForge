    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((node_8698.rg+node_8699.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
...
////// Specular:
                ...
                float node_8608 = 0.1;
                float3 finalColor = ( diffuse + i.shLight ) * lerp(tex2D(_Diffuse,TRANSFORM_TEX(node_8698.rg, _Diffuse)).rgb,float3(node_8608,node_8608,node_8608),node_133) + specular + emissive;
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((node_8700.rg+node_8701.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.posWorld = mul(_Object2World, v.vertex);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
                TRANSFER_VERTEX_TO_FRAGMENT(o)
...
////// Specular:
                ...
                float node_8608 = 0.1;
                float3 finalColor = diffuse * lerp(tex2D(_Diffuse,TRANSFORM_TEX(node_8700.rg, _Diffuse)).rgb,float3(node_8608,node_8608,node_8608),node_133) + specular;
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((o.uv0.rg+node_8703.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_133 = pow((abs((frac((o.uv0.rg+node_8705.g*float2(0.25,0)).r)-0.5))*2.0),_BulgeShape);
                v.vertex.xyz += (node_133*_BulgeScale*v.normal);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex);
