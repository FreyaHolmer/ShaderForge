...
/////// Diffuse:
                ...
                #endif
                float4 node_3 = tex2D(_MainTex,TRANSFORM_TEX(i.uv0.rg, _MainTex));
                float3 finalColor = diffuse * node_3.rgb;
/// Final Color:
