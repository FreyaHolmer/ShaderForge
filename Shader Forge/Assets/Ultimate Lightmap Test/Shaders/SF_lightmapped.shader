...
Shader "Specular/Shader Forge/SF_lightmapped" {
    Properties {
        ...
        _Shininess ("Shininess", Range(0.03, 1)) = 0.3450427
...
////// Specular:
                ...
                float3 directSpecular = 1 * pow(max(0,dot(halfDirection,normalDirection)),specPow)*specularPBL*lightColor;
